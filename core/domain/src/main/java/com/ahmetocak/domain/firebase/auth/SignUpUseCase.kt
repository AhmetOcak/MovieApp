...
class SignUpUseCase @Inject constructor(private val firebaseAuthClient: FirebaseAuthClient) {
    ...
    operator fun invoke(
        ...
        firebaseAuthClient.signUp(email, password).addOnCompleteListener { task ->
